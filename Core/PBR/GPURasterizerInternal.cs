...
public class GPURasterizerInternal
{
    /// <summary>
    /// 정점을 Clip Space -> Screen Space로 변환
    /// </summary>
    public static void Kernel_ConvertVertexToScreenSpace(Index1D idx, ArrayView<Vertex> vertexes, int width, int height)
    {
    ...
    public static void CalculateCache_TrianglesOnPerTileKernel(
    ...
    /// <param name="triangleIndicesPerTile">각 타일별 삼각형 인덱스 배열</param>
    /// <param name="triangleCountPerTile">각 타일에 보여지는 삼각형 개수의 배열</param>
    public static void CalculateRasters_PerTileKernel(
